...
//接收参数
$order9 = isset($_GET['order9'])?$_GET['order9']:'DESC';
...
$sql2 = "SELECT*FROM liebiao ORDER BY prices $order9";//降序
$sql3 = "SELECT * FROM lisonav LIMIT $index,$num";//分页
$sql4 = "SELECT*FROM liebiao ORDER BY prices DESC LIMIT 40";//升序的数量
